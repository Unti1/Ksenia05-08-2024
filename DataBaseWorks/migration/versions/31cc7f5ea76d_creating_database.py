...
Revision ID: 31cc7f5ea76d
Revises: 
Create Date: 2025-03-18 12:08:07.461627
...
def upgrade() -> None:
    ...
    sa.Column('profession', sa.Enum('ADMIN', 'ENGINEER', 'DOCTOR', 'TECHNOLOGIST', 'MANAGER', 'TECHNOLOGY_LEAD', 'PROJECT_MANAGER', 'PROJECT_LEADER', 'UNEMPLOYED', name='professionenum', create_type=False), server_default=sa.text("'UNEMPLOYED'"), nullable=False),
    ...
    sa.Column('status', sa.Enum('PUBLISHED', 'DELETED', 'UNDER_MODERATION', 'DRAFT', 'SCHEDULED', name='statusenum', create_type=False), server_default=sa.text("'DRAFT'"), nullable=False),
...
def downgrade() -> None:
    ...
    op.execute('DROP TYPE IS EXISTS genderenum;')
    op.execute('DROP TYPE IS EXISTS professionenum;')
