...
class Bank:
    ...
    def deposit1(self):
        for _ in range(10):
            ...
            with lock:
                self.deposit += x  
                print(f'Пополнение: {x}. Баланс: {self.deposit}')
                time.sleep(0.5) 
                if self.deposit >= 500:
                    print(f"Баланс достиг 500. Разблокировка.")
                    break 
        ...
        for _ in range(10):
            ...
            with lock:
                ...
                if x > self.deposit: 
                    ...
                    self.deposit -= x 
                    print(f'Снятие: {x}. Баланс: {self.deposit}')
                    time.sleep(0.5)
bk = Bank()
th1 = threading.Thread(target=bk.deposit1)
...
print(f'Итоговый баланс: {bk.deposit}')      
